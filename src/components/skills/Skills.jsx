      ...
      <div className="container md:w-[70%] sm:py-16 py-10">
        <div className="grid items-center gap-4 grid-cols-1 sm:grid-cols-2">
          ...
          <div className="text-slate-600 dark:text-slate-300 sm:order-1 space-y-4">
            ...
            <div>
              <p className="font-semibold">Troubleshooting hardware komputer</p>
              <p className="text-sm text-slate-600 dark:text-slate-300">
                Pengecekan dan perbaikan dasar PC seperti masalah booting, perangkat tidak terdeteksi,
                dan maintenance sederhana komponen hardware.
              </p>
            </div>

            {/* Web programming */}
            <div>
              <p className="font-semibold">Web programming</p>
              <p className="text-sm text-slate-600 dark:text-slate-300">
                Pembuatan halaman website mulai dari development sampai deployment.
              </p>
            </div>
          </div>
        </div>
